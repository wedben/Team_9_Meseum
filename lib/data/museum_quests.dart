  ...
  static const List<Map<String, String>> natureMuseumQuests = [
    {
      ...
      'description': 'Найди самый крупный экспонат и сфотографируй его',
      'type': 'photo',
      'answer': 'moose',
    },
    {
      ...
      'description': 'Найди крупную бабочку с жёлтыми крыльями, синими узорами и красными \"глазками\" с хвостами на крыльях, напиши её латинское название',
      'type': 'text',
    ...
    },
    {
      'id': 'nature_3',
      'name': 'Лесной хряк',
      'description': 'Найди дикого кабана. Сколько пальцев у него на лапе?',
      'type': 'text',
      'answer': '4',
    },
    {
      ...
      'description': 'Найди бурого медведя и отсканируй QR-code рядом с ним',
      'type': 'qr',
      'answer': '',
    },
    {
      'id': 'nature_5',
      'name': 'Следы дикого зверя',
      'description': 'Найди экспонат по следу и сфотографируй его',
      'type': 'photo',
      'answer': 'wolf',
    },
  ];
